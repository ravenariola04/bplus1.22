	...
	<div class="container mtb">
	 	<div class="row">
	 		<div class="col-lg-8">
	 			<h4>Bills Payment</h4>
	 			<div class="hline"></div>
	 			<form role="form" method="POST" action="{{ action('ReservationsController@adminPayBillingDown') }}">
                   	{{ csrf_field() }}
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<h3>Downpayment(50%): 
							<span style="color:red;">&#8369;{{ ($getTotalAmountDue->total + $sumBillingEmployeeServiceFee->totalServiceFee) /2 }}</span>
						</h3>
